...
namespace CertEnroll
{
    class SimpleHTTPServer
    {
        ...
        public SimpleHTTPServer(string path)
        {
            ...
            l.Stop();
            this.Initialize(path,"127.0.0.1", port);
        }
        ...
        public void Start(string path, string ipaddr, int port)
        {
            this.Initialize(path, ipaddr, port);
        }

        private void Listen()
        {
            _listener = new HttpListener();
            _listener.Prefixes.Add("http://"+_ipaddr+":" + _port.ToString() + "/");
        ...
        private void Initialize(string path, string ipadr, int port)
        {
